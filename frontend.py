...
with window("About"):
    add_text("Marin telegram bot")
    add_text("Maintained with <3 by Sinixious (github.com/kajukatliii)")
    add_text("Enviroment:")
    add_text(f"Bot lib: python-telegram-bot v{pver}.", bullet=True)
    add_text(f"Python version: {python_version()}.", bullet=True)
    add_text("Support:")
    add_text("Telegram: t.me/MarinXSupport", bullet=True)
    add_text("Github: github.com/kajukatliii", bullet=True)
